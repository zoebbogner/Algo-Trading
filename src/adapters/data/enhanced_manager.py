...
class EnhancedDataManager:
    ...
    def __init__(self, config: Dict):
        ...
        print(f"🚀 Enhanced Data Manager initialized")
    ...
    def _get_default_symbols(self) -> List[str]:
        ...
        return [
            ...
            # DeFi tokens
            'UNI/USDT', 'LINK/USDT', 'AAVE/USDT', 'COMP/USDT', 'SUSHI/USDT',
            'CRV/USDT', 'YFI/USDT', 'SNX/USDT', 'BAL/USDT', 'REN/USDT',
            ...
            'GALA/USDT', 'ROBLOX/USDT', 'THETA/USDT', 'BAT/USDT', 'HOT/USDT',
            
            # AI and Big Data
            'OCEAN/USDT', 'FET/USDT', 'AGIX/USDT', 'RLC/USDT', 'GRT/USDT',
            'BAND/USDT', 'API3/USDT', 'UMA/USDT', 'ZRX/USDT', 'KNC/USDT',
            
            # Privacy and Security
            'XMR/USDT', 'ZEC/USDT', 'DASH/USDT', 'LTC/USDT', 'BCH/USDT',
            'XNO/USDT', 'RVN/USDT', 'BEAM/USDT', 'PIVX/USDT', 'ARRR/USDT',
            
            # Exchange tokens
            'OKB/USDT', 'HT/USDT', 'KCS/USDT', 'CRO/USDT', 'BTT/USDT',
            'LEO/USDT', 'FTT/USDT', 'GT/USDT', 'MX/USDT', 'WOO/USDT',
            
            # Stablecoins and yield farming
            'USDC/USDT', 'DAI/USDT', 'BUSD/USDT', 'TUSD/USDT', 'FRAX/USDT',
            'USDP/USDT', 'GUSD/USDT', 'HUSD/USDT', 'USDK/USDT', 'USDN/USDT',
            
            # Meme coins and trending
            'SHIB/USDT', 'PEPE/USDT', 'FLOKI/USDT', 'BONK/USDT', 'WIF/USDT',
            'MYRO/USDT', 'POPCAT/USDT', 'BOOK/USDT', 'TURBO/USDT', 'SPONGE/USDT',
            
            # Emerging sectors
            'RNDR/USDT', 'HIVE/USDT', 'STEEM/USDT', 'WAXP/USDT', 'TLM/USDT',
            'ALICE/USDT', 'ALPHA/USDT', 'AUDIO/USDT', 'CLV/USDT', 'CTSI/USDT'
        ]
    ...
    def _initialize_free_sources(self):
        ...
        for exchange in exchanges:
            try:
                ...
                self.adapters[exchange] = CCXTAdapter(exchange_instance, {
    ...
    async def get_historical_data(self, symbol: str, limit: int = 500, 
                                 timeframe: str = None) -> Optional[List[Bar]]:
        """
        ...
        sources = ['binance', 'kucoin', 'okx', 'gate', 'huobi', 'bybit', 'coingecko', 'coinmarketcap']
            ...
            if source_name in self.adapters:
                try:
                    ...
                    if data and len(data) >= limit * 0.8:  # At least 80% of requested data
                        print(f"✅ Successfully fetched {len(data)} bars from {source_name}")
                        return data
                    else:
                        print(f"⚠️ {source_name} returned insufficient data: {len(data) if data else 0} bars")
    ...
    def _calculate_basic_features(self, bars: List[Bar]) -> List[Dict]:
        ...
        volatility = (sum(r*r for r in returns[-20:]) / len(returns[-20:])) ** 0.5 if returns else 0
...
class CoinGeckoAdapter:
    ...
    async def get_historical_data(self, symbol: str, limit: int, timeframe: str) -> Optional[List[Bar]]:
...
class CoinMarketCapAdapter:
    ...
    async def get_historical_data(self, symbol: str, limit: int, timeframe: str) -> Optional[List[Bar]]:
        ...
        print(f"⚠️ CoinMarketCap free tier doesn't support historical data for {symbol}")
        return None
